...
const double _kMinCircularProgressIndicatorWidgetSize = 48.0;
...
/// indicator, see [AdnCircularProgressIndicator]. For a circular progress indicator,
/// see [CircularProgressIndicatorWidget].
///
/// See also:
///
...
class _AdnCircularProgressIndicatorPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_AdnCircularProgressIndicatorPainter oldPainter) {
...
///
/// {@tool dartpad}
/// This example shows a [AdnCircularProgressIndicator] with a changing value.
///
...
/// See also:
///
///  * [CircularProgressIndicatorWidget], which shows progress along a circular arc.
///  * [RefreshIndicator], which automatically displays a [CircularProgressIndicatorWidget]
///    when the underlying vertical scrollable is overscrolled.
///  * <https://material.io/design/components/progress-indicators.html#linear-progress-indicators>
class AdnCircularProgressIndicator extends ProgressIndicator {
  /// Creates a linear progress indicator.
  ///
  /// {@macro flutter.material.ProgressIndicator.ProgressIndicator}
  const AdnCircularProgressIndicator({
    super.key,
    super.value,
  ...
  /// {@template flutter.material.AdnCircularProgressIndicator.trackColor}
  /// Color of the track being filled by the linear indicator.
  ///
  /// If [AdnCircularProgressIndicator.backgroundColor] is null then the
  ...
  /// {@template flutter.material.AdnCircularProgressIndicator.minHeight}
  /// The minimum height of the line used to draw the linear indicator.
  ///
  /// If [AdnCircularProgressIndicator.minHeight] is null then it will use the
  ...
  @override
  State<AdnCircularProgressIndicator> createState() =>
      _AdnCircularProgressIndicatorState();
}

class _AdnCircularProgressIndicatorState
    extends State<AdnCircularProgressIndicator>
  ...
  @override
  void didUpdateWidget(AdnCircularProgressIndicator oldWidget) {
  ...
  Widget _buildIndicator(BuildContext context, double animationValue,
    ...
    return widget._buildSemanticsWrapper(
      ...
      child: Container(
        ...
        child: CustomPaint(
          painter: _AdnCircularProgressIndicatorPainter(
...
///
/// {@tool dartpad}
/// This example shows a [CircularProgressIndicatorWidget] with a changing value.
///
...
/// See also:
///
///  * [AdnCircularProgressIndicator], which displays progress along a line.
///  * [RefreshIndicator], which automatically displays a [CircularProgressIndicatorWidget]
///    when the underlying vertical scrollable is overscrolled.
...
class CircularProgressIndicatorWidget extends ProgressIndicator {
  ...
  /// [CupertinoActivityIndicator] in iOS and [CircularProgressIndicatorWidget] in
  ...
  /// {@template flutter.material.CircularProgressIndicatorWidget.trackColor}
  /// Color of the circular track being filled by the circular indicator.
  ///
  /// If [CircularProgressIndicatorWidget.backgroundColor] is null then the
...
class _RefreshProgressIndicatorPainter
    extends _CircularProgressIndicatorWidgetPainter {
...
///  * [RefreshIndicator], which automatically displays a [CircularProgressIndicatorWidget]
///    when the underlying vertical scrollable is overscrolled.
class RefreshProgressIndicator extends CircularProgressIndicatorWidget {
  ...
  const RefreshProgressIndicator({
    ...
    super.valueColor,
    super.strokeWidth =
        defaultStrokeWidth, // Different default than CircularProgressIndicatorWidget.
    super.semanticsLabel,
    super.semanticsValue,
  });
...
class _RefreshProgressIndicatorState
    extends _CircularProgressIndicatorWidgetState {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return _buildMaterialIndicator(
          ...
          1.05 *
              _CircularProgressIndicatorWidgetState._strokeHeadTween
                  .evaluate(_controller),
          _CircularProgressIndicatorWidgetState._strokeTailTween
              .evaluate(_controller),
          _CircularProgressIndicatorWidgetState._offsetTween
              .evaluate(_controller),
          _CircularProgressIndicatorWidgetState._rotationTween
              .evaluate(_controller),
        );
      },
    );
